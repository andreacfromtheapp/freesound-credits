...
**Anybody can partake in any stage of contribution**. This project
...
If the proposed change alters code, either adding new functionality to
...
That said, if you have several \"checkpoints\" commits that don\'t
...
that the PR doesn\'t need to meet perfection. _Better than the status
quo_ qualifies. One can open follow up Pull Requests to continue
iterating.

When changes prove necessary, _request_ them, don\'t _demand_ them, and
...
Be aware that _how_ you communicate requests and reviews in your
